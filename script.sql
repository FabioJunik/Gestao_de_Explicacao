...
CREATE DATABASE IF NOT EXISTS dbExplicacao;
...
CREATE TABLE tbFalta(
	codFalta INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE tbSala(
	...
	estado CHAR(1) NOT NULL,/* mUDEI ESTE TIPO DE DADO DE BOOLEAN PARA CHAR QUE VAI SER 0 OU 1 */ 
...
ALTER TABLE tbHorario_Turma ADD CONSTRAINT FK_tbTurma_tbHorario_Turma
FOREIGN KEY(cod_Turma) REFERENCES tbTurma(codTurma);

ALTER TABLE tbHorario_Turma ADD CONSTRAINT FK_tbHorario_tbHorario_Turma
...
/* ------------- INSERIR O MASTER ADM --------------------------*/
INSERT INTO tbAdiministrador(nome, password) VALUES('FMMADDSADM22','12344321');
INSERT INTO tbExplicacao(nome, cod_Adm) VALUES('JA-SE-EXPLICA', 1);
INSERT INTO tbNormaPagamento(dataLimite, multa, cod_Explicacao) VALUES(NULL, NULL, 1);